...
\include{./01-elementos-pre-textuais/folha-aprovacao}       % Comando para imprimir Folha de aprovação
...
\include{./02-elementos-textuais/desenvolvimento}           % Desenvolvimento
\include{./02-elementos-textuais/avaliacao}                 % Avaliação
